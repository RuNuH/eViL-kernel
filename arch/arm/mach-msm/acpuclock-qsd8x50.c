...
struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 1036800, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x1B, 0, 1250, 128000  },
	...
	{ 1190400, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x1F, 0, 1275, 128000  },
//	{ 1228800, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x20, 0, 1300, 128000  },
//	{ 1267000, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x21, 0, 1300, 128000  },
	{ 0 },
};
